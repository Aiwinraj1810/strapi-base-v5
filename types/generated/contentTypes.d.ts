...
export interface ApiEmailConfigurationEmailConfiguration
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DefaultEmailSender: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    EmailTemplate: Schema.Attribute.RichText &
...
export interface ApiRemoteConfigRemoteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Config: Schema.Attribute.Component<'global.config', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    PageCollectionType: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    PageDocumentID: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSitemapSitemap extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    PageType: Schema.Attribute.Enumeration<
      ['default', 'news-listing', 'news-detail']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTranslationTranslation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TranslationArabic: Schema.Attribute.Text;
    TranslationEnglish: Schema.Attribute.Text;
    TranslationKey: Schema.Attribute.String & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
